package com.xinwen.mybatis.node02.config;
...
public class MysqlProdDatasourceConfig {
    //数据源配置的 prod 扫描的路径
    static final  String PACKAGE="com.xinwen.mybatis.node02.mapper.prod";
    //mybatis mapper扫描路径
    static final String MAPPER_LOCATION = "classpath*:prod/*.xml";
