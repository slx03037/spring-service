package com.xinwen.shardingsphere.jdbc.node02.config;


import com.xinwen.shardingsphere.jdbc.node02.utils.SpringUtil;
...
public class ShardingAlgorithmTool {
    /** 表分片符号，例：t_order_202201 中，分片符号为 "_" */
