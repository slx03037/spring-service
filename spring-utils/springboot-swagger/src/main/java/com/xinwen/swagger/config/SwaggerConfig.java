package com.xinwen.swagger.config;
...
import com.xinwen.swagger.config.entity.SwaggerProperties;
import com.xinwen.swagger.response.ResponseStatus;
    ...
    public Docket docket() {
        return new Docket(DocumentationType.OAS_30).
                ...
                // 通过 .select() 方法去配置扫描接口, RequestHandlerSelectors 配置如何扫描接口
                        apis(RequestHandlerSelectors.basePackage("com.swagger.first.com.xinwen.mybatis.node01.controller")).
